...
class DataManager(object):
    ...
    def __init__(self, source_type, dest_type, file_info, db_info,
        ...
        if file_info is not None:
            ...
            self.input_path = self.directory + input_folder
            if not os.path.isdir(self.input_path):
                os.makedirs(self.input_path)

            self.output_path = self.directory + output_folder
            if not os.path.isdir(self.output_path):
                os.makedirs(self.output_path)

            self.used_path = self.directory + used_folder
            ...
            self.dataset_file = self.directory + self.dataset_fname + '.pkl'
            self.datalabels_file = (
            ...
            self.labelhistory_file = (self.directory +
                                      self.labelhistory_fname + '.pkl')
            self.exportlabels_file = (
    ...
    def loadData(self, source_type='file'):
